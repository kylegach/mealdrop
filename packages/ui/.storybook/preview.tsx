...
export const withStore: Decorator = (StoryFn, { parameters }) => {
  ...
  // Using a minimal reducer for UI package - stories that need full store should provide their own
  const defaultState = {
    cart: {
      visible: false,
      items: [],
  ...
  const store = configureStore({
    ...
    preloadedState: parameters.store?.initialState || defaultState, // if undefined, just use default state from reducers
  })
  return (
